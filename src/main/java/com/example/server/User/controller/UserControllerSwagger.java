...
public interface UserControllerSwagger {
    ...
    @ApiResponses({
        ...
        @ApiResponse(responseCode = "401", description = "유효하지 않은 토큰"
                    , content = @Content(schema = @Schema(implementation = NeurousApiResponse.class)))
    })
    ...
    ResponseEntity<NeurousApiResponse<?>> logout(
        @Parameter(description = "리프레시 토큰", hidden = true)
        String refresh
    );
    ...
    ResponseEntity<NeurousApiResponse<?>> profile(
    ...
    ResponseEntity<NeurousApiResponse<?>> updateProfile(
        @Parameter(description = "인증된 사용자 ID", hidden = true)
        String userId,
    ...
    ResponseEntity<NeurousApiResponse<?>> deleteProfileImage(
        @Parameter(description = "인증된 사용자 ID", hidden = true)
        String userId
    );
    ...
    ResponseEntity<NeurousApiResponse<?>> withdraw(
        @Parameter(description = "인증된 사용자 ID", hidden = true)
        String userId,
        @Parameter(description = "리프레시 토큰", hidden = true)
        String refresh
